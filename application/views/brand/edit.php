...
<body>
    ...
    <div class="container">
        <div class="card p-5">
            ...
            <form action="<?php echo base_url().'index.php/brand/edit/'.$brand['id']?>" method="POST">
                <div class="form-group">
                    <label for="brand">Update Brand</label>
                    
                    <input type="text" name="name" class="form-control"  placeholder="Update Brand Name" value="<?php echo $brand['name'] ?>">
